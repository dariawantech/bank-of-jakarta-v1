...
-- You may not use this software if you have not validly acquired a license for the software from Dariawan or its licensed distributors.
--
-- Create tables for Bank of Jakarta, the tutorial's online banking application.
...
GRANT ALL PRIVILEGES ON TABLE ACCOUNT TO duke;
GRANT ALL PRIVILEGES ON TABLE CUSTOMER TO duke;
GRANT ALL PRIVILEGES ON TABLE TX TO duke;
GRANT ALL PRIVILEGES ON TABLE CUSTOMER_ACCOUNT_XREF TO duke;
GRANT ALL PRIVILEGES ON TABLE NEXT_ID TO duke;